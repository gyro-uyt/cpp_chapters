...
print(s1[1:])   # python automatically fills the empty space with lenght of the string i.e. '22'

print(s1[1:-5]) # all the negative indexes are added to the lenght of the index, then that lenght is used
