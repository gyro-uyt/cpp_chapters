...
#  use '''__''' or """___""" for multi-line comments
''' 
he
hhe
hhe
...
print("hey", 5, "wowo", 90) # print multiple things from one statement
print("hey", 5, "wowo", 90, sep = "--") # sep will put whatever you give it btw. the multiple prints of single-line
print("hey", 5, "wowo", 90, end = "~69~") # default value of end="\n", putting something will put that after print prints its arguements
